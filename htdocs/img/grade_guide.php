...
<h4 class="w3-border-bottom w3-border-light-grey w3-padding-16">등급별 가이드</h4>
  <div class="w3-row-padding" style="text-align:center">
    <div class="w3-third w3-container w3-margin-bottom">
      <img src='bronze.png' style="width:40%" class="w3-hover-opacity">
    ...
    <div class="w3-third w3-container w3-margin-bottom">
      <img src='silver.png' style="width:40%" class="w3-hover-opacity">
      <div class="w3-container w3-white">
        <h4><b>실버</b></h4>
    ...
    <div class="w3-third w3-container w3-margin-bottom">
      <img src='gold.png' style="width:40%" class="w3-hover-opacity">
      <div class="w3-container w3-white">
        <h4><b>골드</b></h4>
        <p>예약 점수 7점 이상 고객</p>
      </div>
